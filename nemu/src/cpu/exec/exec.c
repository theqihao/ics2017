...
/* 0x80, 0x81, 0x83 */
make_group(gp1,
    EX(add), EX(or), EMPTY, EXW(sbb, 1),
    EXW(and, 1), EX(sub), EX(xor), EX(cmp))

  /* 0xc0, 0xc1, 0xd0, 0xd1, 0xd2, 0xd3 */
make_group(gp2,
    EX(rol), EMPTY, EMPTY, EMPTY,
    EX(shl), EX(shr), EMPTY, EXW(sar, 1))
...
make_group(gp4,
  ...
  /* 0xff */
make_group(gp5,
    EXW(inc, 1), EX(dec), EX(call_rm), EMPTY,
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x28 */	IDEXW(G2E, sub, 1), IDEX(G2E, sub), IDEXW(G2E, sub, 1), IDEX(E2G, sub),
  ...
  /* 0x68 */	IDEX(I, push), EMPTY, IDEXW(I, push, 1), IDEX(I_E2G, imul3),
  /* 0x6c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x70 */	IDEXW(J, jcc, 1), EMPTY, IDEXW(J, jcc, 1), IDEXW(J, jcc, 1),
